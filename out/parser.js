...
exports.DEFAULT_TEMPLATE = exports.DEFAULT_DATA = void 0;
...
function compose(template, data) {
    const componentDetails = data.components
        ...
        .join("\n\n");
    const resolvedVisualDir = data.visualDirection.replace(/@\[([^\]]+)\]/g, (_match, name) => `@${name}`);
    let result = template;
    const replacements = {
...
exports.DEFAULT_TEMPLATE = `# UI Design System Composer
